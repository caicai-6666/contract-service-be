...
def build_document_understanding_subgraph() -> Any:
    """延迟导入并装配已准备 PDF 的文档结构理解子图。"""
    from app.agent.contract_extraction.subgraph.document_understanding import (
        build_document_understanding_subgraph as build,
    )
